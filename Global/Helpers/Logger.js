...
const webhookLogger = j2poncik.WebhookURL ? new WebhookClient({ url: j2poncik.WebhookURL }) : undefined;
...
function sendWebhook(content, err) {
  ...
  webhookLogger.send({ username: "System Eror", embeds: [embed] }).catch((ex) => {});
