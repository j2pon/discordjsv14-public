...
module.exports = {
    ...
    if(!j2ponm.ConfirmerRoles.some(j2ponlan => message.member.roles.cache.has(j2ponlan)) && !j2ponm.OwnerRoles.some(j2ponlan => message.member.roles.cache.has(j2ponlan)) && !message.member.permissions.has(PermissionsBitField.Flags.Administrator)) return;
